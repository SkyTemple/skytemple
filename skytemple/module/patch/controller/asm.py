...
class AsmController(AbstractController):
        ...
        if model is not None and treeiter is not None:
            ...
            if name == "ExpandPokeList":
                md = SkyTempleMessageDialog(
                    ...
                    _(
                        "This patch extends the Pokémon list. It is very experimental and "
    ...
    def refresh(self, patch_category: Optional[PatchCategory]):
        ...
        page.pack_start(
            builder_get_assert(self.builder, Gtk.ScrolledWindow, "patch_window"),
            True,
            True,
            0,
        )
    ...
    def _load_image_for_issue_dialog(self):
        ...
        builder_get_assert(self.builder, Gtk.Box, "issue_img_container").pack_start(
            img, False, False, 0
        )
    ...
    def _error_or_issue(self, is_load: bool, is_error: bool, errors_or_issues):
        ...
        buffer = builder_get_assert(
            self.builder, Gtk.TextView, "issue_info"
        ).get_buffer()
    ...
    def _activate_issues(self):
        ...
        if not self._were_issues_activated:
            builder_get_assert(self.builder, Gtk.ButtonBox, "cnt_btns").pack_start(
                builder_get_assert(self.builder, Gtk.Button, "btn_show_issues"),
                True,
                True,
                0,
            )
            ...
            self._msg(
                _(
                    "Some of the loaded patches had compatibility issues. "
                    ...
                    "click the 'Show Issues' button for more information."
                ),
                Gtk.MessageType.WARNING,
            )
    ...
    def _show_code_warning(self):
        ...
        md = SkyTempleMessageDialog(
            ...
            Gtk.ButtonsType.YES_NO,
            _(
                "Warning! The project directory for this ROM contains custom patches. "
