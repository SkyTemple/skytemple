...
class ZMappaTController(AbstractController):
    ...
    def get_view(self) -> Gtk.Widget:
        ...
        builder_get_assert(self.builder, Gtk.DrawingArea, "draw_tiles").connect(
            "draw", self.draw_tiles
        )
        builder_get_assert(self.builder, Gtk.DrawingArea, "draw_masks").connect(
            "draw", self.draw_masks
        )
    ...
    def _reinit_image(self):
        ...
        if builder_get_assert(
            self.builder, Gtk.Switch, "switch_minimized"
        ).get_active():
