...
class FloorController(AbstractController):
    ...
    def get_view(self) -> Gtk.Widget:
        ...
        if not self.module.project.is_patch_applied("ExpandPokeList"):
            builder_get_assert(
                self.builder, Gtk.Widget, "switch_kecleon_gender"
            ).destroy()
            builder_get_assert(
                self.builder, Gtk.Widget, "label_kecleon_gender"
            ).destroy()
        ...
        self._init_drawer()
        tool_fullmap = builder_get_assert(
            self.builder, Gtk.ToggleToolButton, "tool_fullmap"
        )
        ...
        item_list_notebook = builder_get_assert(
            self.builder, Gtk.Notebook, "item_list_notebook"
        )
    ...
    def on_cb_tileset_id_changed(self, w, *args):
        ...
        auto_refresh = builder_get_assert(
            self.builder, Gtk.ToggleToolButton, "tool_auto_refresh"
        ).get_active()
        tool_fullmap = builder_get_assert(
            self.builder, Gtk.ToggleToolButton, "tool_fullmap"
        ).get_active()
    ...
    def on_btn_help_room_density_clicked(self, *args):
        self._help(
            _(
                "The game randomly adds a number between 0 and 2 to obtain the final value. "
    ...
    def on_btn_help_dead_ends_clicked(self, *args):
        self._help(
            _(
                "Controls whether dead end hallways can be generated in the floor. "
    ...
    def on_btn_help_floor_connectivity_clicked(self, *args):
        self._help(
            _(
                "Floor connectivity (Min 1, if it's 0 a valid map can't be generated and you will get the default "
    ...
    def on_btn_help_extra_hallway_density_clicked(self, *args):
        self._help(
            _(
                'Used to generate additional hallways in the map (those "donuts" that lead to nowhere, multiple '
    ...
    def on_btn_help_unused_chance_clicked(self, *args):
        self._help(
            _(
                'Does not work in the game. To make it work, apply the "UnusedDungeonChance" from '
    ...
    def on_btn_goto_tileset_clicked(self, *args):
        idx = builder_get_assert(
            self.builder, Gtk.ComboBox, "cb_tileset_id"
        ).get_active()
    ...
    def on_btn_goto_fixed_floor_clicked(self, *args):
        idx = builder_get_assert(
            self.builder, Gtk.ComboBox, "cb_fixed_floor_id"
        ).get_active()
        if idx > 0:
    ...
    def on_cr_monster_spawns_weight_edited(self, widget, path, text):
        ...
        store[path][5] = text
        if builder_get_assert(
            self.builder, Gtk.Switch, "monster_spawns_keep_synced_toggle"
        ).get_active():
            store[path][7] = text
    ...
    def on_monster_spawns_remove_clicked(self, *args):
        tree: Gtk.TreeView = builder_get_assert(
            self.builder, Gtk.TreeView, "monster_spawns_tree"
        )
    ...
    def on_cr_items_cat_name_changed(self, widget, path, new_iter, *args):
        ...
        cb_store = builder_get_assert(
            self.builder, Gtk.ListStore, "cr_item_cat_name_store"
        )
    ...
    def on_item_categories_add_clicked(self, *args):
        ...
        dialog: Gtk.Dialog = builder_get_assert(
            self.builder, Gtk.Dialog, "dialog_category_add"
        )
    ...
    def on_item_categories_remove_clicked(self, *args):
        tree: Gtk.TreeView = builder_get_assert(
            self.builder, Gtk.TreeView, "item_categories_tree"
        )
        model, treeiter = tree.get_selection().get_selected()
    ...
    def on_cr_items_cat_thrown_pierce_item_name_editing_started(
        ...
        editable.set_completion(
            builder_get_assert(
                self.builder, Gtk.EntryCompletion, "completion_item_thrown_pierce"
            )
        )
    ...
    def on_cr_items_cat_thrown_rock_item_name_editing_started(
        ...
        editable.set_completion(
            builder_get_assert(
                self.builder, Gtk.EntryCompletion, "completion_item_thrown_rock"
            )
        )
    ...
    def on_cr_items_cat_berries_item_name_editing_started(
        ...
        editable.set_completion(
            builder_get_assert(
                self.builder, Gtk.EntryCompletion, "completion_item_berries"
            )
        )
    ...
    def on_cr_items_cat_foods_item_name_editing_started(self, renderer, editable, path):
        editable.set_completion(
            builder_get_assert(
                self.builder, Gtk.EntryCompletion, "completion_item_foods"
            )
        )
    ...
    def on_cr_items_cat_hold_item_name_editing_started(self, renderer, editable, path):
        editable.set_completion(
            builder_get_assert(
                self.builder, Gtk.EntryCompletion, "completion_item_hold"
            )
        )
    ...
    def on_cr_items_cat_tms_item_name_editing_started(self, renderer, editable, path):
        editable.set_completion(
            builder_get_assert(self.builder, Gtk.EntryCompletion, "completion_item_tms")
        )
    ...
    def on_cr_items_cat_orbs_item_name_editing_started(self, renderer, editable, path):
        editable.set_completion(
            builder_get_assert(
                self.builder, Gtk.EntryCompletion, "completion_item_orbs"
            )
        )
    ...
    def on_cr_items_cat_others_item_name_editing_started(
        ...
        editable.set_completion(
            builder_get_assert(
                self.builder, Gtk.EntryCompletion, "completion_item_others"
            )
        )
        ...
        try:
            try:
                rng = random.Random(
                    int(
                        builder_get_assert(
                            self.builder, Gtk.Entry, "tool_entry_seed"
                        ).get_text()
                    )
                )
            except ValueError:
            ...
            if floor is None:
                stack.set_visible_child(
                    builder_get_assert(self.builder, Gtk.Box, "preview_error_infinite")
                )
                return
            if self._draw is not None:
            ...
            tb: Gtk.TextBuffer = builder_get_assert(
                self.builder, Gtk.TextBuffer, "preview_error_buffer"
            )
            tb.set_text(
                "".join(
            ...
            stack.set_visible_child(
                builder_get_assert(self.builder, Gtk.Widget, "preview_error")
            )
    ...
    def on_btn_help_tool_seed_clicked(self, *args):
        self._help(
            _(
                "This seed is used as the base to randomly generate the actual seeds used by the "
    ...
    def on_btn_help__spawn_tables__clicked(self, *args):
        self._help(
            ...
            + "\n\n"
            + _(
                "If 'Use same spawn weights for Monster Houses' is checked, the same spawn weights are used for "
    ...
    def on_btn_export_clicked(self, *args):
        ...
        if resp == Gtk.ResponseType.APPLY:
            ...
            xml = mappa_floor_to_xml(
                ...
                .get_static_data()
                .dungeon_data.item_categories,
                export_layout=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_layout"
                ).get_active(),
                export_monsters=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_monsters"
                ).get_active(),
                export_traps=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_traps"
                ).get_active(),
                export_floor_items=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_floor_items"
                ).get_active(),
                export_shop_items=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_shop_items"
                ).get_active(),
                export_monster_house_items=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_monster_house_items"
                ).get_active(),
                export_buried_items=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_buried_items"
                ).get_active(),
                export_unk1_items=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_unk_items1"
                ).get_active(),
                export_unk2_items=builder_get_assert(
                    self.builder, Gtk.Switch, "export_type_unk_items2"
                ).get_active(),
            )

            # 1. Export to file
            if builder_get_assert(
                self.builder, Gtk.Switch, "export_file_switch"
            ).get_active():
    ...
    def on_item_list_notebook_switch_page(
        ...
        sw: Gtk.ScrolledWindow = builder_get_assert(
            self.builder, Gtk.ScrolledWindow, "sw_item_editor"
        )
    ...
    def _init_layout_stores(self):
        ...
        if self.module.has_floor_ranks():
            ...
            builder_get_assert(
                self.builder, Gtk.ComboBox, "cb_floor_ranks"
            ).set_sensitive(False)
        if self.module.has_mission_forbidden():
            ...
            builder_get_assert(
                self.builder, Gtk.ComboBox, "cb_mission_forbidden"
            ).set_sensitive(False)
    ...
    def _init_monster_spawns(self):
        ...
        for i, monster in enumerate(self.entry.monsters):
            ...
            if monster.md_index in KECLEON_MD_INDEX:
                builder_get_assert(
                    self.builder, Gtk.Entry, "kecleon_level_entry"
                ).set_text(str(monster.level))
                switch = builder_get_assert(
                    self.builder, Gtk.Switch, "switch_kecleon_gender"
                )
        ...
        builder_get_assert(
            self.builder, Gtk.Switch, "monster_spawns_keep_synced_toggle"
        ).set_active(are_all_weight_types_same_values)

    def _init_monster_completion_store(self):
        monster_md = self.module.get_monster_md()
        monster_store: Gtk.ListStore = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_monsters_store"
        )
    ...
    def _init_item_spawns(self):
        ...
        item_categories_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_categories_store"
        )
        item_cat_thrown_pierce_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_cat_thrown_pierce_store"
        )
        item_cat_thrown_rock_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_cat_thrown_rock_store"
        )
        item_cat_berries_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_cat_berries_store"
        )
        item_cat_foods_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_cat_foods_store"
        )
        item_cat_hold_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_cat_hold_store"
        )
        item_cat_tms_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_cat_tms_store"
        )
        item_cat_orbs_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_cat_orbs_store"
        )
        item_cat_others_store = builder_get_assert(
            self.builder, Gtk.ListStore, "item_cat_others_store"
        )
        item_stores = {
    ...
    def _init_item_completion_store(self):
        completion_item_thrown_pierce_store = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_item_thrown_pierce_store"
        )
        completion_item_thrown_rock_store = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_item_thrown_rock_store"
        )
        completion_item_berries_store = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_item_berries_store"
        )
        completion_item_foods_store = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_item_foods_store"
        )
        completion_item_hold_store = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_item_hold_store"
        )
        completion_item_tms_store = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_item_tms_store"
        )
        completion_item_orbs_store = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_item_orbs_store"
        )
        completion_item_others_store = builder_get_assert(
            self.builder, Gtk.ListStore, "completion_item_others_store"
        )
        completion_stores = {
    ...
    def _save_item_spawn_rates(self):
        item_stores = {
            None: builder_get_assert(
                self.builder, Gtk.ListStore, "item_categories_store"
            ),
            self.item_categories[0]: builder_get_assert(
                self.builder, Gtk.ListStore, "item_cat_thrown_pierce_store"
            ),
            self.item_categories[1]: builder_get_assert(
                self.builder, Gtk.ListStore, "item_cat_thrown_rock_store"
            ),
            self.item_categories[2]: builder_get_assert(
                self.builder, Gtk.ListStore, "item_cat_berries_store"
            ),
            self.item_categories[3]: builder_get_assert(
                self.builder, Gtk.ListStore, "item_cat_foods_store"
            ),
            self.item_categories[4]: builder_get_assert(
                self.builder, Gtk.ListStore, "item_cat_hold_store"
            ),
            self.item_categories[5]: builder_get_assert(
                self.builder, Gtk.ListStore, "item_cat_tms_store"
            ),
            self.item_categories[9]: builder_get_assert(
                self.builder, Gtk.ListStore, "item_cat_orbs_store"
            ),
            self.item_categories[8]: builder_get_assert(
                self.builder, Gtk.ListStore, "item_cat_others_store"
            ),
        }
        ...
        for cat, store in item_stores.items():
            ...
            for row in rows:
                ...
                if row[2]:
                    ...
                    if int(row[4]) != 0:
                        weight = last_weight + int(
                            10000 * (int(row[4]) / sum_of_weights)
                        )
                        last_weight = weight
                        was_set = True
                if cat is None:
