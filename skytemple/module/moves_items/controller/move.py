...
class MoveController(AbstractController):
    ...
    def on_btn_help_miss_accuracy_clicked(self, w, *args):
        md = SkyTempleMessageDialog(
            ...
            Gtk.ButtonsType.OK,
            _(
                "Seems to be a second sort of accuracy check. "
    ...
    def on_btn_help_settings_range_ai_clicked(self, w, *args):
        md = SkyTempleMessageDialog(
            ...
            Gtk.ButtonsType.OK,
            _(
                "When deciding what move to use, the AI will treat the move like it actually has the range settings "
                "configured here."
            )
            + _(
    ...
    def on_btn_help_message_id_clicked(self, w, *args):
        md = SkyTempleMessageDialog(
            ...
            Gtk.ButtonsType.OK,
            _(
                "Message ID offset that is displayed for the move. 0 uses the Text String 3860. Higher values select "
    ...
    def on_btn_help_range_check_text_clicked(self, w, *args):
        md = SkyTempleMessageDialog(
            ...
            Gtk.ButtonsType.OK,
            _(
                "Text string to display to describe the range of the move. 0 uses the Text String 10095/10097 (US/EU). Higher values select "
                "the strings after that (offsets)."
            ),
