#!/bin/sh
if [ "$1" = "i686" ]; then
  curl https://skytemple.org/build_deps/win32/py_desmume-0.0.4.post1-cp39-cp39-mingw_i686.whl -O
  ...
  curl https://skytemple.org/build_deps/py_desmume-0.0.4.post1-cp39-cp39-mingw_x86_64.whl -O
