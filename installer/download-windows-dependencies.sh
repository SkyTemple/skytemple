#!/bin/sh
if [ "$1" = "i686" ]; then
  curl https://skytemple.org/build_deps/win32/py_desmume-0.0.4-cp39-cp39-mingw_i686.whl -O
  curl https://skytemple.org/build_deps/win32/skytemple_rust-1.3.4.post0-cp39-cp39-mingw_i686.whl -O
  ...
  curl https://skytemple.org/build_deps/py_desmume-0.0.4-cp39-cp39-mingw_x86_64.whl -O
  curl https://skytemple.org/build_deps/skytemple_rust-1.3.4.post0-cp39-cp39-mingw_x86_64.whl -O
