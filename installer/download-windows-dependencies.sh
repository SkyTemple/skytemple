...
if [ "$1" = "i686" ]; then
  ...
  curl https://skytemple.org/build_deps/win32/python_igraph-0.8.2-cp39-cp39-mingw_i686.whl -O
  ...
  curl https://skytemple.org/build_deps/python_igraph-0.8.2-cp39-cp39-mingw_x86_64.whl -O
  curl https://skytemple.org/build_deps/armips.exe -O
fi
