#!/bin/sh
if [ "$1" = "i686" ]; then
  curl https://skytemple.org/build_deps/win32/py_desmume-0.0.3-cp38-cp38-mingw.whl -O
  ...
  curl https://skytemple.org/build_deps/py_desmume-0.0.3.post2-cp38-cp38-mingw.whl -O
