#!/bin/sh
if [ "$1" = "i686" ]; then
  curl https://skytemple.org/build_deps/win32/py_desmume-0.0.4.post2-cp310-cp310-mingw_i686.whl -O
  ...
  curl https://skytemple.org/build_deps/py_desmume-0.0.4.post2-cp310-cp310-mingw_x86_64.whl -O
