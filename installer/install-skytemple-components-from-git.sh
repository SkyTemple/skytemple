...
pip3 uninstall -y skytemple-files && pip3 install git+https://github.com/SkyTemple/skytemple-files.git@version/1.5.x
...
pip3 uninstall -y skytemple-ssb-debugger && pip3 install git+https://github.com/SkyTemple/skytemple-ssb-debugger.git@version/1.5.x
