...
pip uninstall skytemple skytemple-files skytemple-ssb-debugger explorerscript py-desmume skytemple-rust tilequant py-desmume skytemple-randomizer skytemple-icons skytemple-dtef -y
